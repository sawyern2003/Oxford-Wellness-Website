/** Shared sitemap / robots content for Express (local/Replit) and Vercel serverless. */
...
export const SITEMAP_PAGES = [
  ...
  { path: "/blog/botox-first-time-guide", priority: "0.7", changefreq: "monthly" },
  ...
  { path: "/blog/doctor-vs-nurse-aesthetics", priority: "0.7", changefreq: "monthly" },
